...
<head>
    ...
    <title>@yield('title', 'Student Blockchain Management')</title>
...
<body>
    <div class="container">
        <div class="header fade-in">
            <h1><i class="fas fa-link"></i> Student Blockchain Management</h1>
        ...
        <nav class="nav fade-in">
            ...
            <a href="{{ route('students.blockchain') }}" class="nav-link {{ request()->routeIs('students.blockchain') ? 'active' : '' }}">
            ...
            deleteButtons.forEach(btn => {
                if (btn.textContent.includes('Delete')) {
                    btn.addEventListener('click', function(e) {
                        if (!confirm('Are you sure you want to delete this student? This action will create a new record in the blockchain.')) {
                            e.preventDefault();
                        }
                    });
                }
